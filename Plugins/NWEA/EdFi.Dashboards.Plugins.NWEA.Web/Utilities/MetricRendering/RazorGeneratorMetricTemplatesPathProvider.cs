...
namespace EdFi.Dashboards.Plugins.NWEA.Web.Utilities.MetricRendering
{
    public class RazorGeneratorMetricTemplatesPathProvider : MetricTemplateVirtualPathsProviderBase
    {
        ...
        {
            var files = from type in typeof(Marker_EdFi_Dashboards_Plugins_NWEA_Web).Assembly.GetTypes()
